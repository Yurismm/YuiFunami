...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        const embed = new MessageEmbed()
            ...
            .addField("Created and developed by:", "cherie#0004, [Dodo#1797](https://discord.bio/p/dodo), [Meliodas#0001](https://discord.bio/p/meliodas), [xgrvaeli#0880](https://xgrvae.li)")
